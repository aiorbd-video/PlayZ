...
// 🟢 MATCH_API এখান থেকে সরিয়ে নিচে আলাদা ভেরিয়েবল হিসেবে দেওয়া হয়েছে
import { fetcher, getMatchStatus, getCategoryIcon } from './utils/helpers';
import { ChannelCard, MatchCard } from './components/Cards';

// 🚀 তোমার নতুন লাইভ ইভেন্টের লিংকটি এখানে বসাও (ফায়ারবেস বা হাগিং ফেসের লিংক)
'use client';
...
export default function Home() {
  ...
  // 🎯 ২. এখানে নতুন LIVE_EVENTS_API কল করা হয়েছে
